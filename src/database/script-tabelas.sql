...
insert into empresa (nome, codigo) values ('Empresa 1', 'ED145B5SS');
insert into empresa (nome, codigo) values ('Empresa 2', 'A1B2C33AE');
insert into plantacao (nome, fkMatriz) values ('Plantação 1', 1);
insert into plantacao (nome, fkMatriz) values ('Plantação 2', 2);
